...
export default function SareesPage({ products }) {
    ...
    <main className="bg-ivory min-h-screen pt-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center border-b-2 border-gold pb-4 mb-12">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Sarees Collection</h1>
          <p className="mt-4 text-lg text-charcoal/80">Elegant traditional sarees for every occasion.</p>
        </div>
